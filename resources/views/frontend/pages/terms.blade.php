    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <x-frontend.card>
                ...
                <x-slot name="body">
                    <p>非常歡迎您光臨「靠北護理師」，<a href="https://nursing.init.engineer">nursing.init.engineer</a>（以下簡稱本網站）為<a href="https://github.com/Kantai235"> 乾太 ₍₍ ◝(･◡･)◟ ⁾⁾ </a>所經營管理之網路平台，為了讓您能夠安心使用平台上的各項服務與資訊，特此向您說明本網站的隱私權保護政策（以下簡稱本政策），以保障您的權益，請您詳閱下列內容，並確實遵守，謝謝。</p>
