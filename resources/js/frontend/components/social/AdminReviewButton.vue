  ...
  mounted() {
    ...
    axios
      ...
      .catch(function (error) {
        ...
        Swal.fire(
          "噢噗！怪怪的？",
          '載入投票資訊時發生了一些錯誤，可以的話，把這項問題拿到<a href="https://github.com/init-engineer/nursing.init.engineer"> GitHub repo </a>發個 issue 給我，謝謝你 m(_ _)m',
          "error"
        );
      });
  },
    ...
    yesVoting() {
      ...
      axios
        ...
        .catch(function (error) {
          ...
          Swal.fire(
            "噢噗！怪怪的？",
            '投票時發生了一些錯誤，可以的話，把這項問題拿到<a href="https://github.com/init-engineer/nursing.init.engineer"> GitHub repo </a>發個 issue 給我，謝謝你 m(_ _)m',
            "error"
          );
        });
    },
