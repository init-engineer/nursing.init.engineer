<template>
  <div>
    ...
    <!-- 假的即時渲染 -->
    <div class="media" v-for="(c, index) in comment" v-bind:key="index">
      <img
        class="rounded mr-2"
...
export default {
  ...
  methods: {
    submit() {
      ...
      self.status = "submit";
      axios
        .post(`/api/social/cards/${this.cid}/comments`, data)
        ...
        .catch(function (error) {
          ...
          Swal.fire(
            "噢噗！怪怪的？",
            '留言時發生了一些錯誤，可以的話，把這項問題拿到<a href="https://github.com/init-engineer/nursing.init.engineer"> GitHub repo </a>發個 issue 給我，謝謝你 m(_ _)m',
            "error"
          );
        });
    },
