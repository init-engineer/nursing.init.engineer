        ...
        <ul class="steps p-0" @click="onClickListener($event)">
          ...
          <li ref="listItem2" class="listItem" id="step2">
            ...
            <div ref="stepBody" class="col2 stepBody">
              ...
              <div class="row mt-2">
                <div
                  class="col-6 col-md-4 col-lg-3 p-1"
                ...
                >
                  <input
                    ...
                    name="theme"
                    :id="theme"
                    v-model="selector.theme"
                    v-bind:value="theme"
                  />
                  <label :for="theme">
                    <img
                      :src="`/img/frontend/article/theme/${theme}.png`"
              ...
              <div class="row mt-2">
                ...
                >
                  <input
                    ...
                    name="font"
                    :id="font"
                    v-model="selector.font"
                    v-bind:value="font"
                  />
                  <label :for="font">
                    <img
                      :src="`/img/frontend/article/font/${font}.png`"
                      class="img-fluid rounded"
                    />
                  </label>
                </div>
            ...
            <div ref="stepBody" class="col2 stepBody">
              ...
              <div class="jumbotron jumbotron-fluid rounded p-2 mt-2">
                ...
                <div class="mt-2 text-center">
                  ...
                  <label
                    style="display: inline-block"
                    :class="[consent ? 'text-success' : 'text-danger']"
                    for="consent"
                  >
                    {{
                      consent
