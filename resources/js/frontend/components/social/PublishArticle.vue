                ...
                <ul class="steps p-0" @click="onClickListener($event)">
                    ...
                    <li ref="listItem1" class="listItem show" id="step1">
                        ...
                        <div ref="stepBody" class="col2 stepBody">
                            <div class="stepTitle">Step 1 - 編輯文章內容</div>
                            <div class="content">
                    ...
                    <li ref="listItem2" class="listItem" id="step2">
                        ...
                        <div ref="stepBody" class="col2 stepBody">
                            <div class="stepTitle">Step 2 - 選擇主題樣式</div>
                            <div class="row mt-2">
                                <div class="col-6 col-md-4 col-lg-3 p-1" v-for="theme in themes" v-bind:key="theme">
                                    <input type="radio" name="theme" :id="theme" v-model="selector.theme"
                                        v-bind:value="theme" />
                                    <label :for="theme">
                                        <img :src="`/img/frontend/article/theme/${theme}.png`"
                    ...
                    <li ref="listItem3" class="listItem" id="step3">
                        ...
                        <div ref="stepBody" class="col2 stepBody">
                            <div class="stepTitle">Step 3 - 選擇字型樣式</div>
                            <div class="row mt-2">
                                <div class="col-6 col-md-4 col-lg-3 p-1" v-for="font in fonts" v-bind:key="font">
                                    <input type="radio" name="font" :id="font" v-model="selector.font"
                                        v-bind:value="font" />
                                    <label :for="font">
                                        <img :src="`/img/frontend/article/font/${font}.png`"
                                            class="img-fluid rounded" />
                                    </label>
                                </div>
                            </div>
                    ...
                    <li ref="listItem4" class="listItem" id="step4">
                        ...
                        <div ref="stepBody" class="col2 stepBody">
                            <div class="stepTitle">Step 4 - 同意版規</div>
                            <div class="jumbotron jumbotron-fluid rounded p-2 mt-2">
                                <div class="container p-0">
                                    ...
                                    <ol class="pb-2">
                                        ...
                                        <li>
                                            請學習包容各種意見，如遇惡意批評或攻擊之文章，切勿加入爭執，並且善用私訊告知，版主會有適當之處理，否則雙方皆依上述規定處理。
                                        </li>
                                    </ol>
                                </div>
                    ...
                    <li ref="listItem5" class="listItem" id="step5">
                        ...
                        <div ref="stepBody" class="col2 stepBody">
                            <div class="stepTitle">Step 5 - 最後確認</div>
                            <div class="content">
                                <article-preview :content="content" :theme="selector.theme" :font="selector.font" />
                    ...
                    <li ref="listItem6" class="listItem" id="step6">
                        ...
                        <div ref="stepBody" class="col2 stepBody">
                            <div class="stepTitle">Step 6 - 完成</div>
        ...
        submitForm() {
            ...
            axios
                ...
                .catch((error) => {
                    ...
                    Swal.fire(
                        "噢噗！怪怪的？",
                        '投稿文章時發生了一些錯誤，可以的話，把這項問題拿到<a href="https://github.com/init-engineer/nursing.init.engineer"> GitHub repo </a>發個 issue 給我，謝謝你 m(_ _)m',
                        "error"
                    );
                });
        },
